...
The points can be out of specifications because of mechanical issues to apply the proper force on the ground and/or impossibility to position the vibrator in the planned point (for example, because an object, river, tree, or anything else is present), among others.
The project goal is to automate this process. The program does the following:
    ...
    - Create a list and update the files with new sheets, whose content are the points to reacquire the next day. The name of the sheets include the date the VPs were acquired, for easier identification of the day.<br><br>
