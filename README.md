...
This project is about automation of quality control task of seismic data acquisition using the files generated by the recorder instrument for that purpose. Except for the content referenced in this README file and/or the code and/or the website, all content is invented by me, anything matching reality is just a coincidence.
